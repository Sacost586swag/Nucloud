...
/**
 * Formulario de captación reutilizable (Home y subpágina /contacto). Envía
 * todos los datos al webhook de n8n e incluye casilla obligatoria de aceptación
 * de la política de privacidad.
 *
 * Envío: se intenta primero un POST JSON normal (respuesta legible si el webhook
 * tiene CORS habilitado); si el navegador lo bloquea por CORS, se reintenta en
 * modo `no-cors` para que los datos lleguen igualmente. El payload captura
 * `window.location.href`, así que el origen por página es automático.
 */
